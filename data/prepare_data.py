...
def resize_multiple(img, sizes=(16, 256), resample=Image.BICUBIC, lmdb_save=False):
...
def prepare(img_path, out_path, n_worker, sizes=(16, 256), resample=Image.BICUBIC, lmdb_save=False):
